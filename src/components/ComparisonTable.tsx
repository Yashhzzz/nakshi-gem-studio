...
const ComparisonTable = () => {
  return (
    <section className="py-[120px]" style={{ background: '#291C0E' }}>
          ...
          <table className="w-full min-w-[600px]">
            <thead>
              <tr style={{ background: '#3E2522' }}>
                <th className="font-body text-[12px] uppercase tracking-wide p-4 text-left" style={{ color: '#D3A376' }}>
                  Feature
                </th>
                <th className="font-body text-[12px] uppercase tracking-wide p-4 text-left" style={{ color: '#D3A376' }}>
                  Studio Shoot
                ...
                <th
                  className="font-body text-[12px] uppercase tracking-wide p-4 text-left font-semibold"
            ...
            <tbody>
              {rows.map((row, i) => (
                <tr key={i} style={{ background: i % 2 === 0 ? '#291C0E' : 'rgba(255,255,255,0.03)' }}>
                  <td className="font-body text-[14px] p-4" style={{ color: 'rgba(255,242,223,0.8)' }}>
                    {row.feature}
                  </td>
